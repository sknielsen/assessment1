...
def all_odd(numbers):
    ...
    For example::
        ...
        []
    """
    odds_list = [number for number in numbers if number % 2 != 0]
...
def print_indices(items):
    ...
    """
    # Iterate over indices in items list
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    """
    # Get the intersection of the two lists as sets
    common_foods_set = set(foods1) & set(foods2)
    # Store the intersection set as a sorted list
    common_foods = sorted(list(common_foods_set))
    return common_foods
...
def every_other_item(items):
    ...
    """
    # store items in list if their index is an even number 
    ever_other_list = [items[i] for i in range(len(items)) if i % 2 == 0]
    return ever_other_list
...
def largest_n_items(items, n):
    ...
    separately::
        ...
        [3, 3]
    """
    # Sort items list in reverse
    items.sort(reverse=True)
    # Store n number of items in new list
    largest_numbers = items[:n]
    # Sort list
